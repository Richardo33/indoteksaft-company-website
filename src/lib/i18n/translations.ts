...
export const enToId = {
  ...
  "Isi data singkat berikut agar tim sales kami dapat membantu follow-up kebutuhan perusahaan Anda.": "Isi data singkat berikut agar tim sales kami dapat membantu follow-up kebutuhan perusahaan Anda.",
  ...
  COMPANY: "PERUSAHAAN",
  Careers: "Karier",
  "Build Meaningful Technology with Indoteksaft": "Bangun Teknologi Bermakna Bersama Indoteksaft",
  "We are preparing a dedicated careers page for future roles, culture, and hiring information.": "Kami sedang menyiapkan halaman karier khusus untuk informasi posisi, budaya kerja, dan rekrutmen mendatang.",
  "Future Opportunities": "Peluang Mendatang",
  "Our careers page is currently being prepared. For now, candidates or talent partners can contact our team through the official email or contact sales page.": "Saat ini halaman karier sedang disiapkan. Untuk sementara, kandidat atau partner talent dapat menghubungi tim kami melalui email resmi atau halaman contact sales.",
  Engineering: "Engineering",
  Infrastructure: "Infrastruktur",
  "Project Delivery": "Project Delivery",
  Operations: "Operasional",
  "Role information will be available soon.": "Informasi posisi akan tersedia segera.",
